...
const news = () => {
    return <>
        <div className="centralnewsGrid">Noticia central
            ...
            <div className="secnews1Grid">Noticia secundaria1</div>
            <div className="secnews2Grid">Noticia secundaria2</div>
            <div className="secnews3Grid">Noticia secundaria3</div>
    </>;
}
